...
export BUILD_TOP_MENU_LABELS=HZERO_MENU
export BUILD_TOP_MENU_UNION_LABEL=true
...
find ./html -name '*.js' | xargs sed -i "s BUILD_TOP_MENU_LABELS $BUILD_TOP_MENU_LABELS g"
